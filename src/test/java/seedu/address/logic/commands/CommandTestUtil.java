...
public class CommandTestUtil {
    ...
    public static final String VALID_POSITION_AMY = "Teaching Assistant";
    public static final String VALID_POSITION_BOB = "Professors";
    ...
    public static final String INVALID_POSITION_DESC = " " + PREFIX_POSITION + "TA@CS"; // '@' not allowed
     ...
     *
     * Similar to {@code assertCommandSuccess} but does not depend potentially flaky
     * {@code CommandResult} matching
     */
    public static void assertCommandSuccessModelOnly(Command command, Model actualModel, Model expectedModel) {
        try {
